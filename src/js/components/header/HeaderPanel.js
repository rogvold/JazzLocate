        ...
        return (
            <div style={assign({}, this.componentStyle.headerPlaceholder, {backgroundColor: this.props.backgroundColor})}>
                <div style={this.componentStyle.header}>
                    ...
                    <div style={assign({}, this.componentStyle.rightBlock)}>

                        {this.props.customHeaderComponent == null ? null :
                            <div className={'customHeaderComponentPlaceholder'}
                                 style={this.componentStyle.customHeaderComponentPlaceholder}>
                        ...
                        {this.props.isLoggedIn == false ?
                            (
                                <div className={'loginLink'} style={this.componentStyle.loginLink} >
